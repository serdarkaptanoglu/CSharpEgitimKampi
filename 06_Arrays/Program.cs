...
namespace _06_Arrays
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //string[] colors = { "Sarı", "Kırmızı", "Mavi", "Yesil", "Turuncu", "Pembe" };
            ...
            //string[] customers = { "ali", "buse", "aysegul", "merve", "cinar", "kaya" };
            ...
            int[] numbers = { 21, 42, 33, 54, 55, 661, 897, 748, 39, 220 };
            for (int i = 0; i < numbers.Length; i++)
            {
                if (numbers[i] % 2 == 0)
                {
                    Console.WriteLine(numbers[i] + " Sayısı cifttir.");
               
                }
                else
                {
                    Console.WriteLine(numbers[i] + " Sayısı tektir.");
                }
            Console.WriteLine();
            }
            ;
